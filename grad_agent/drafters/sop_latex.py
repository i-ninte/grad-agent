...
\rhead{\small \href{<<PORTFOLIO_URL>>}{<<PORTFOLIO_URL>>}}
...
def build(
    ...
    # Portfolio URL from profile.yaml (portable across users)
    try:
        from .. import config as _cfg
        portfolio_url = _cfg.load_profile().portfolio or "https://example.com"
    except Exception:
